...
class StreamDispatcher extends Writable {
  ...
  _step(done) {
    ...
    this._sdata.lastMessage += TIMESTAMP_INC;
    if (this._sdata.sequence >= 2 ** 16) this._sdata.sequence = 0;
    if (this._sdata.lastMessage >= 2 ** 32) this._sdata.lastMessage = 0;
    this.count++;
  }
  ...
  _playChunk(chunk) {
    ...
    this._sendPacket(this._createPacket(this._sdata.sequence, this._sdata.lastMessage, chunk));
  }
  ...
  _createPacket(sequence, lastMessage, buffer) {
    const packetBuffer = Buffer.alloc(12);
    packetBuffer[0] = 0x80;
    packetBuffer[1] = 0x78;

    packetBuffer.writeUIntBE(sequence, 2, 2);
    packetBuffer.writeUIntBE(lastMessage, 4, 4);
