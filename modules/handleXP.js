...
exports.voice = (client, oldVoiceState, newVoiceState, database) => {
  ...
  if (((newVoiceState.channel == null && !oldVoiceState.deaf && oldVoiceState.channel !== null) || newVoiceState.deaf || ((oldVoiceState.channel !== newVoiceState.channel) && !oldVoiceState.deaf && oldVoiceState.channel !== null)) && !(oldVoiceState.channel.id === config.pillowsAFK || oldVoiceState.guild.id !== config.pillowsID || (oldVoiceState.channel === null && newVoiceState.channel.id === config.pillowsAFK))) { // END XP COUNT
